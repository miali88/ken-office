...
export const MOCK_PERIODIC_CASE_REVIEW_OPERATIONS: DocumentOperation[] = [
  ...
  },
  {
    ...
    tableIndex: 0,
    row: 0,
    cell: 3, // Details column
    value: "Company name confirmed from Companies House register and appointment documentation. Entity entered creditors' voluntary liquidation on 15 March 2024.",
    checklistMetadata: {
      references: [
  ...
  },
  {
    ...
    row: 1,
    cell: 3,
    value: "Internal case reference assigned upon appointment. Follows firm's CVL case numbering convention.",
    checklistMetadata: {
      references: [
  ...
  },
  {
    ...
    row: 2,
    cell: 3,
    value: "Case type confirmed as CVL under s90 Insolvency Act 1986. Members' resolution passed on 15 March 2024 followed by creditors' decision.",
    checklistMetadata: {
      references: [
  ...
  },
  {
    ...
    row: 3,
    cell: 3,
    value: "Liquidator appointment effective 15 March 2024 at 14:30 following creditors' decision procedure. Appointment confirmed via Companies House filing.",
    checklistMetadata: {
      references: [
  ...
  },
  {
    ...
    row: 4,
    cell: 3,
    value: "Sarah Mitchell (IP number 12345) appointed as sole liquidator. Authorised by ICAEW. Bond in place for £500,000.",
    checklistMetadata: {
      references: [
  ...
  },
  {
    ...
    row: 5,
    cell: 3,
    value: "David Thompson assigned as primary case manager, supported by junior associate Emma Williams. Both have relevant CVL experience.",
    checklistMetadata: {
      references: [
  ...
  // Note: This table has a different layout with date fields split across multiple cells
  // Keeping original structure as these are date component fields, not full rows with Status/Details
  // ====================
  {
    type: "fillTableCell",
    tableIndex: 1,
    row: 0, // Date of last case review - Day
    cell: 1,
    value: "15"
  },
  {
  ...
  // Note: This table has Yes/No/N/A checkboxes, so structure may be different
  // Keeping checkbox values in column 1 or 3, but adding Status/Details for items that have commentary
  // ====================
  // Assets row
  {
    type: "fillTableCell",
  ...
  },
  {
    ...
    row: 1,
    cell: 3, // Details column
    value: "All company assets have been realised. Plant & machinery sold at auction (£125,000), stock sold to trade buyer (£45,000), and debtor book collected (£23,400 recovered from £67,000). No CVA contributions applicable. Total realisations: £193,400.",
    checklistMetadata: {
      references: [
  ...
  },
  {
    ...
    tableIndex: 2,
    row: 2,
    cell: 4, // Status column (may be offset due to checkbox columns)
    value: "Not Required"
  },
  {
    type: "fillTableCell",
    tableIndex: 2,
    row: 2,
    cell: 5, // Details column
    value: "This is a CVL case. Director conduct investigations under the Company Directors Disqualification Act 1986 do not apply to CVL cases. Investigations are only mandatory for compulsory liquidations (CWU), administrations (ADM), and administrative receiverships. The liquidator has conducted preliminary enquiries and found no evidence of fraudulent or wrongful trading requiring separate investigation.",
    checklistMetadata: {
      references: [
  ...
  // Note: Date fields split across cells - simpler structure
  // ====================
  {
    type: "fillTableCell",
    tableIndex: 3,
  ...
  },
  {
    type: "fillTableCell",
    tableIndex: 3,
    row: 2, // First progress report due - Day
    cell: 1,
    value: "N/A"
  },
  ...
  },
  {
    ...
    row: 0,
    cell: 3, // Details column
    value: "All post-appointment VAT returns are up to date. Final return submitted for period ending 28 February 2025 (submitted 31/03/2025). Company deregistered for VAT effective 31 March 2025 following completion of all trading activity and asset realisations. VAT on debt factoring fees has been recovered where applicable (£3,450 recovered). No outstanding VAT compliance issues.",
    checklistMetadata: {
      references: [
  ...
  },
  {
    ...
    row: 2,
    cell: 3, // Details column
    value: "Company successfully deregistered for VAT effective 31 March 2025. Deregistration application submitted 15 March 2025 following completion of all taxable activities. HMRC confirmation received 15 April 2025. No further VAT obligations remain.",
    checklistMetadata: {
      references: [
  ...
  // Note: Date fields - keeping simple structure
  // ====================
  {
    type: "fillTableCell",
    tableIndex: 5,
  ...
  },
  {
    ...
    row: 0,
    cell: 5, // Details column
    value: "Latest bank reconciliation completed for month ending 28 February 2025. Reconciliation shows closing balance of £67,234.56 in liquidation account (Barclays a/c ****1234). All receipts and payments verified against supporting documentation. No unreconciled items. Copy appended to case file.",
    checklistMetadata: {
      references: [
  ...
  // ====================
  {
    type: "fillTableCell",
    tableIndex: 6,
    row: 0, // CT returns outstanding - No checkbox
    cell: 2,
    value: "X"
  },
  {
  ...
  // ====================
  {
    type: "fillTableCell",
    tableIndex: 7,
    row: 0, // Bribery Act concerns - No checkbox
    cell: 2,
    value: "X"
  },
  {
  ...
  // ====================
  {
    type: "fillTableCell",
    tableIndex: 8,
    row: 0, // Ethical issues - No checkbox
    cell: 2,
    value: "X"
  },
  {
  ...
  // ====================
  {
    type: "fillTableCell",
    tableIndex: 9,
    row: 0, // 3rd party instructions documented - Yes checkbox
    cell: 1,
    value: "X"
  },
  {
  ...
  },
  {
    type: "fillTableCell",
    tableIndex: 9,
    row: 1, // Best value review - Yes checkbox
    cell: 1,
    value: "X"
  },
  {
